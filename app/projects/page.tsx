...
import ShadowReader from "./ShadowReader";
import { X, Info, Swords, Trophy, Brush, User, Eye } from "lucide-react";
...
export default function Projects() {
  ...
  const descriptions = [
    ...
    },
    {
      title: "Shadow Reader",
      icon: <Eye></Eye>,
      desc: "The Ultimate Dark Mode PDF Reader",
...
const cards = [
  {
    ...
    thumbnailBorderClass: "border-red-900 red-glow bg- white dark: bg-[#0B141F]",
  ...
  },
  {
    ...
    title: "",
    titleClass: "",
    thumbnailBorderClass: "border-purple-600 purple-glow",
  ...
  },
  {
    ...
    thumbnailBorderClass: "border-blue-[#67A6E3] dark:border-blue-600 blue-glow",
  ...
  },
  {
    ...
    thumbnailBorderClass: "border-orange-500 orange-glow",
    ...
    {
      description: "A dark mode PDF reader for comfortable night reading.",
      title: "",
      titleClass: "text-emerald-500",
      thumbnailBorderClass: "border-emerald-500 green-glow",
      src: "https://res.cloudinary.com/dp56p8qeg/image/upload/v1730300997/m5rxjedshgltpkgw5pqf.png",
      layout: "col-span-2 row-span-1",
      content: <ShadowReader />,
      modalClass: "border-emerald-500 bg-black/80",
    },
  ];
          ...
          <div className="fixed inset-0 grid place-items-center z-[49]">
            <div
              ...
              className={`
                ...
                ${
                  active.modalClass ? `${active.modalClass}` : " dark:border-[#545454] border-gray-400"
                }
                `}
            >
              <div className="h-full customScroll">
                {/* Close button */}
                <motion.button
                  className="flex lg:fixed absolute top-4 right-4 lg:left-0 lg:top-0 lg:right-auto items-center justify-center rounded-full h-8 w-8 z-50 lg:m-0 cursor-pointer"
                  onClick={() => setActive(null)}
                >
                  <X />
                </motion.button>
                <div className="lg:pt-8 h-full">
                  {active.content}
                </div>
              </div>
            </div>
          ...
          return (
            <div
              ...
              className={`
                ...
                border ${card.thumbnailBorderClass}
